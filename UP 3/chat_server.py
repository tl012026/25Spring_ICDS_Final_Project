...
# ==============================================================================
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    something_really_interesting = {"action": "exchange", "message": message, "from": from_name}
                    mysend(to_sock, json.dumps(something_really_interesting))
                    # ---- end of your code --- #
...
# ==============================================================================
                ...
                if len(the_guys) == 1:  # only one left
                    ...
                    to_sock = self.logged_name2sock[g]
                    mysend(to_sock, json.dumps(
                        {"action": "disconnect", "from": from_name, "message": "everyone left, you are alone"}))
# ==============================================================================
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                listed_poem = self.sonnet.get_poem(int(msg["target"]))
                poem = ''.join(listed_poem)
                print('here:\n', poem)
                # ---- end of your code --- #
...
# ==============================================================================
                ...
                term = msg["target"]
                search_rslt = {}
                for i in self.indices.items():
                    x = i[1].search(term)
                    for j in x:
                        if j[0] not in search_rslt.keys():
                            search_rslt[j[0]] = j[1]
                        else:
                            search_rslt[j[0]] += j[1]
                # ---- end of your code --- #
