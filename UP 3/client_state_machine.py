        ...
        if self.state == S_LOGGEDIN:
            ...
            if len(peer_msg) > 0:
                ...
                if peer_msg["action"] == "connect":
                    ...
                    who = peer_msg["from"]
                    self.peer = who
                    self.out_msg += f"Request from {who}\n"
                    self.out_msg += f"You are connedcted with {who}. Chat away!\n\n"
                    self.out_msg += '-----------------------------------\n'
                    self.state = S_CHATTING
                    # ----------end of your code----#
...
#==============================================================================
            ...
            if len(peer_msg) > 0:    # peer's stuff, coming in
                ...
                if peer_msg["action"] == "disconnect":
                    self.state = S_LOGGEDIN
                if peer_msg["action"] == "connect":
                    self.out_msg += f'(time: {ctime}) ({peer_msg["from"]} joined)\n'
                # ----------end of your code----#
